...
fn split(raw: String) -> Result<(String, String), Box<Error>> {
    ...
    if setting.is_empty() || data.is_empty() {
        return return Err(Box::new(StandardError::new("lack")))
    }
...
fn parse_map(w: usize, h: usize, life_map: String) -> Vec<bool> {
...
#[test]
fn test_parse_map() {
    assert_eq!(parse_map(4, 4, "2o$bobo$3bo!".to_string()), [
